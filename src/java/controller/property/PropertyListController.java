...
public class PropertyListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Property> list = dao.getAllProperty(Integer.valueOf(paramIndex), 6);
        List<PropertyType> listPropertyType = daoPt.getListPropertyTypes();
        int totalRows = dao.getTotalRowsCondition("", "", "", "", "");
        ...
        request.getRequestDispatcher("ViewPropertyList.jsp").forward(request, response);
    }
