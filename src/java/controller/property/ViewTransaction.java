 ...
 * @author MSI
 */
@WebServlet(name = "ViewTransaction", urlPatterns = {"/ViewTransaction"})
public class ViewTransaction extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("landlord") == null) {
            ...
            DAOTransactions dao = new DAOTransactions();
            DAOPropertyType daopt = new DAOPropertyType();
            String typeTransaction = request.getParameter("typeTransaction");
            String sortType = request.getParameter("sortType");
            List<Transactions> list = dao.getTransationHistory(landlord.getId(), typeTransaction, sortType);
