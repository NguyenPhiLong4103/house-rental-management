...
<head>
    ...
    <!-- Template Stylesheet -->
    <link href="css/style.css_1" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="js/main.js"></script>
                ...
                %>
                <a href="AdminController?service=displayTenant&index=<%=i%>" type="button" class="btn btn-primary"><%=i%></a>
                <%}%>
                                        </div>
                                    </div>
                                </div>
    ...
    <body>
        ...
        <form action="AdminController" method="post">
            <table>
                <tr>
                    <th>Account ID</th> 
                    <td><input name="uid" value="<%=up.getInt("id")%>" readonly></td>
                </tr><tr>
                    <th>Email</th> 
                    <td><%=up.getString("email")%></td> 
                </tr><tr>
                    <th>Role ID</th>
                    <td><%=up.getInt("role_id")%></td> 
                </tr>
                    <tr>
                    <th>Status</th>
                    ...
                    <option value="4">4</option>                    
                        </select> (Current: <%=up.getInt("status")%>)</td> 
                </tr><tr>
                    <th><input type="submit" value="Update Status" name="submit"></th>
