...
<%@page import="entity.Account,entity.Admin" %>
	 ...
	 <div class="col-sm-6 space_left">
	  <div class="submit_1i1 clearfix">
	    <h5 class="mgt">First Name</h5>
            <input class="form-control" value="<%=admin.getFirstName()%>" type="text" name="fname">
	  </div>
	 </div>
	 <div class="col-sm-6 space_right">
	  <div class="submit_1i1 clearfix">
	    <h5 class="mgt">Last Name</h5>
	    <input class="form-control" value="<%=admin.getLastName()%>" type="text" name="lname">
	  </div>
	 </div>
	</div>
