...
<%@page import="entity.Account,entity.Tenant" %>
...
<html lang="en">
    ...
    <body>
        <%
            ...
            Tenant tenant =(Tenant) request.getAttribute("user");
                            ...
                            <div class="submit_1i clearfix">
                                <div class="col-sm-6 space_left">
                                    <div class="submit_1i1 clearfix">
                                        ...
                                        <input class="form-control" value="<%=tenant.getFirstName()%>" type="text" name="fname">
                                    </div>
                                </div>
                                <div class="col-sm-6 space_right">
                                    <div class="submit_1i1 clearfix">
                                        <h5 class="mgt">Last Name</h5>
                                        <input class="form-control" value="<%=tenant.getLastName()%>" type="text" name="lname">
                                    </div>
                                </div>
                            </div>
                            <div class="submit_1i clearfix">
                                <div class="col-sm-6 space_left">
                                    <div class="submit_1i1 clearfix">
                                        <h5>Address</h5>
                                        <input class="form-control" placeholder="Enter Your Adress" <%if(tenant.getAddress()!=null){%>
                                               value="<%=tenant.getAddress()%>"
                                ...
                                <div class="col-sm-6 space_right">
                                    <div class="submit_1i1 clearfix">
                                        <h5>Phone</h5>
                                        <input class="form-control" placeholder="Enter Your Phone" <%if(tenant.getPhone()!=null){%>
                                               value="<%=tenant.getPhone()%>"
